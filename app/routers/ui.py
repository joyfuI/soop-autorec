...
async def create_channel(
    ...
    skip_subscription_plus: str | None = Form(default=None),
    ...
    try:
        ...
        channel_model.create_channel(
            ...
            enabled=enabled == "on",
            skip_subscription_plus=skip_subscription_plus == "on",
...
async def toggle_channel(
    ...
    channel_model.update_channel(
        ...
        enabled=next_enabled,
        skip_subscription_plus=channel["skip_subscription_plus"],
